      ...
      <header class="main-header">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
            <a class="navbar-brand" href="{{ url('/') }}"><i class="fa fa-paper-plane"></i> الرئيسية</a>
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                          ...
                          <a href="{{ url('/adminpanel/change_status/'.$buWaiting->id.'/1') }}" class="pull-left">
                          <span>
                             تفعيل العقار
                          </span>
                        </a>

                          <a href="{{ url('/adminpanel/bu/'.$buWaiting->id.'/edit') }}" class="pull-right">
                          <span>
                             {{ $buWaiting->bu_name }}
                          </span>
                        </a>
